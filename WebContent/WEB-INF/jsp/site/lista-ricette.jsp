...
<!-- 	<div class="row"><div class="col-">FILTRI</div></div> -->
<!-- 	<div  id="beerItem" class="row"> -->
<!-- 		<div class=" col-md-2 col-lg-4 card"> -->
<!-- 	    <img class="card-img-top" src="https://via.placeholder.com/164x192.png?text=image placeholder" alt="Card image"> -->
<!-- 	    	<div class="card-body"> -->
